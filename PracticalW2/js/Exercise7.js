...
export function main(){
    ...
    //Materials
    const lambertMat = new THREE.MeshLambertMaterial( {color: 0x4fe5ff});
    ...
    const cone = new THREE.Mesh( geometry, lambertMat );
    ...
    const cylinder = new THREE.Mesh( geometry, phongMat );
    ...
    //Exercise 1 Cornel Box Architecture
    const floorRect = rectLight(10, 10, 1);
    const rightWallRect = rectLight(10, 10, 1, 0x00ff00);
    const leftWallRect = rectLight(10, 10, 1, 0xff0000);
    const backWallRect = rectLight(10, 10, 1);
    const ceilingRect = rectLight(10, 10, 1);
    ...
    holder.add(floorRect);

    holder.add(rightWallRect);
    holder.add(leftWallRect);
    holder.add(backWallRect);
    holder.add(ceilingRect);
    ...
    holder.position.setX(-5);
    holder.position.setY(-3);
    holder.position.setZ(-10);
